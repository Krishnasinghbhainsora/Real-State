...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Logging in with:', identifier, password, 'as', userType);

    try {
      const response = await axios.post("http://localhost:8000/user/login", { identifier, password, userType });
        ...
        <div className="container-fluid signup-page">
          ...
          <div className={`form-section ${isLeftContentVisible ? '' : 'centered'}`} style={{ marginTop: '-40px' }}>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Button onClick={handleSubmit} variant="danger" type="submit" block style={{ width: '100%' }}>
                Login
              </Button>
            </Form>
