...
const HeroSection = () => {
  ...
  const fetchCitiesAndLocalities = async (query) => {
    if (!query) return;
    ...
    try {
      ...
      setSearchResults(data.cities); // Assuming the API returns a `cities` array
    } catch (error) {
      ...
      <div className="hero-section">
        ...
        <div className="content">
          ...
          <Nav className="nav-links">
            ...
            <Link
              to="/plot"
              className={location.pathname === "/plot" ? "active" : ""}
              style={{ color: "#fff", textDecoration: "none" }}
            >
              Plot
            </Link>
          ...
          <Form className="search-form ">
            ...
            <FormControl
              ...
              onChange={(e) => {
                ...
                setSearchTerm(query);
                fetchCitiesAndLocalities(query); // Call API on input change
              }}
            />
            ...
            >
              <Dropdown.Toggle
                ...
                aria-controls="property-type-dropdown-menu"
              ...
              <Dropdown.Menu
                id="property-type-dropdown-menu"
              ...
              >
                <div className="category-menu">
                  <div
                    ...
                    style={{
                      marginBottom:
                        expandedCategory === "Residential" ? submenuHeight : 0,
                    }}
                  >
                    <Dropdown.Header
                      ...
                      >
                        ...
                        {selectedPropertyTypes.includes("Flat") && (
                          ...
                          >
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Flat", "1 BHK")
                              }
                              className={
                                selectedSubcategory.Flat === "1 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Flat", "2 BHK")
                              }
                              className={
                                selectedSubcategory.Flat === "2 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Flat", "3 BHK")
                              }
                              className={
                                selectedSubcategory.Flat === "3 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Flat", "4 BHK")
                              }
                              className={
                                selectedSubcategory.Flat === "4 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                        ...
                        {selectedPropertyTypes.includes("House/Villa") && (
                          ...
                          >
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("House/Villa", "1 BHK")
                              }
                              className={
                                selectedSubcategory["House/Villa"] === "1 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("House/Villa", "2 BHK")
                              }
                              className={
                                selectedSubcategory["House/Villa"] === "2 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("House/Villa", "3 BHK")
                              }
                              className={
                                selectedSubcategory["House/Villa"] === "3 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("House/Villa", "4 BHK")
                              }
                              className={
                                selectedSubcategory["House/Villa"] === "4 BHK"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                        ...
                        {selectedPropertyTypes.includes("Plot") && (
                          ...
                          >
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Plot", "500 sqft")
                              }
                              className={
                                selectedSubcategory.Plot === "500 sqft"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Plot", "1000 sqft")
                              }
                              className={
                                selectedSubcategory.Plot === "1000 sqft"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                            ...
                            <Dropdown.Item
                              onClick={() =>
                                handleSubcategorySelect("Plot", "2000 sqft")
                              }
                              className={
                                selectedSubcategory.Plot === "2000 sqft"
                                  ? "selected-item"
                                  : ""
                              }
                            >
                    ...
                    {expandedCategory === "Commercial" && (
                      ...
                      >
                        <Dropdown.Item
                          ...
                          className={
                            selectedPropertyTypes.includes("Office Space")
                              ? "selected-item"
                              : ""
                          }
                        >
                        ...
                        <Dropdown.Item
                          ...
                          className={
                            selectedPropertyTypes.includes("Shop/Showroom")
                              ? "selected-item"
                              : ""
                          }
                        >
                  ...
                  <div className="property-item" style={{ fontSize: "15px" }}>
                    ...
                    {expandedCategory === "Others" && (
                      ...
                      >
                        <Dropdown.Item
                          onClick={() => handlePropertySelect("Farmhouse")}
                          className={
                            selectedPropertyTypes.includes("Farmhouse")
                              ? "selected-item"
                              : ""
                          }
                        >
                        ...
                        <Dropdown.Item
                          onClick={() =>
                            handlePropertySelect("Service Apartment")
                          }
                          className={
                            selectedPropertyTypes.includes("Service Apartment")
                              ? "selected-item"
                              : ""
                          }
                        >
            ...
            >
              <Dropdown.Toggle
                ...
                aria-controls="budget-dropdown-menu"
                className="budget-dropdown-toggle"
              >
                {selectedBudget || "Budget"}
                {/* <FaAngleDown className="dropdown-arrow-icon" /> */}
              </Dropdown.Toggle>
              <Dropdown.Menu
                id="budget-dropdown-menu"
                className="dropdown-menu-custom"
              >
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("Below ₹20 Lacs")}
                >
                  Below ₹20 Lacs
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("₹20 Lacs to ₹40 Lacs")}
                >
                  ₹20 Lacs to ₹40 Lacs
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("₹40 Lacs to ₹60 Lacs")}
                >
                  ₹40 Lacs to ₹60 Lacs
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("₹60 Lacs to ₹80 Lacs")}
                >
                  ₹60 Lacs to ₹80 Lacs
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("₹80 Lacs to ₹1 Crore")}
                >
                  ₹80 Lacs to ₹1 Crore
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => handleBudgetSelect("Above ₹1 Crore")}
                >
                  Above ₹1 Crore
                </Dropdown.Item>
              </Dropdown.Menu>
