...
function ManageProperties() {
  ...
  // Simulate fetching data from backend (useEffect for API call)
  useEffect(() => {
    // axios.get('/api/properties').then(response => setProperties(response.data))
    setProperties(initialProperties);
  }, []);

  // Function to handle responses click (simulating for now)
  ...
  // Function to delete a property (simulating deletion for now)
